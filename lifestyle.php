...
<div id="page-wrapper">
			...
			<!-- Features -->
				<section id="features">
					<div class="container">
						<header>
							<h2>Search properties by lifestyle</h2>
						</header>
						<div class="row aln-center">
							<div class="col-4 col-6-medium col-12-small">
								...
								<!-- Feature -->
									<section>
										<a href="beach.php" class="image featured"><img src="images/bc.jpg" alt="" /></a>
										<header>
											<h3>Tranquil Beachfront Homes. EXPLORE TURQUOISE WATERS AND WHITE SANDY BEACHES</h3>
										</header>
							...
							<div class="col-4 col-6-medium col-12-small">
								...
								<!-- Feature -->
									<section>
										<a  class="image featured"><img src="images/cat.jpg" alt="" /></a>
										<header>
											<h3>Luxury Country Living. DISCOVER WIDE OPEN SPACES AND COUNTRY ESTATES</h3>
										</header>
							...
							<div class="col-4 col-6-medium col-12-small">
								...
								<!-- Feature -->
									<section>
										<a  class="image featured"><img   height="200" src="images/is.jpg" alt="" /></a>
										<header>
											<h3>Private Island Properties .OWN A SLICE OF PARADISE</h3>
										</header>
						...
						<div class="row aln-center">
							<div class="col-4 col-6-medium col-12-small">
								...
								<!-- Feature -->
									<section>
										<a class="image featured"><img  width="250" height="200" src="images/farm.jpg" alt="" /></a>
										<header>
											<h3>Farm and Ranch Properties .EXPLORE RURAL ESTATES AND TROPHY RANCHES</h3>
										</header>
							...
							<div class="col-4 col-6-medium col-12-small">
								...
								<!-- Feature -->
									<section>
										<a  class="image featured"><img height="200" src="images/his.jpg" alt="" /></a>
										<header>
											<h3>Fine Historic Estates and Properties. CREATE YOUR OWN CHAPTER IN HISTORY</h3>
										</header>
							...
							<div class="col-4 col-6-medium col-12-small">
								...
								<!-- Feature -->
									<section>
										<a  class="image featured"><img  height="200" src="images/metro.jpg" alt="" /></a>
										<header>
											<h3>Luxury Metropolitan Properties .DISCOVER YOUR OWN URBAN O</h3>
										</header>
