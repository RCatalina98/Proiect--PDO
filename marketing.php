				...
				<section id="header">
				 ...
				 <br></br>
				  ...
				  <br></br>
					...
					<img src="images/img11.jpg" alt="" style="width:1500px;height:600px;">
					...
					<div class="container">
						<div class="row">
							...
							<!-- Content -->
								<div id="content" class="col-8 col-12-medium">
									...
									<!-- Post -->
										<article class="box post">
											<p><font size=5>When your home is represented by the TRILLIONAIRE MANSIONS brand it benefits from the worldwide recognition and prestige of the TRILLIONAIRE's name and gains exclusive access to highly qualified global clientele. 
											See below how the TRILLIONAIRE MANSIONS brand is successfully connecting homes with buyers worldwide.</font></p>
								...
								<article class="box post">
								<p><font size=4>We have established a truly global presence, with innovative technology and unrivaled service. 
								When a home is marketed through the TRILLIONAIRE MANSIONS network it immediately begins a journey to worldwide exposure.</font></p>
                               </article>
							   

							
							   <div class="col-12" align="center">
												<a href="offices.php" class="button">FIND AN OFFICE</a>
								</div>
